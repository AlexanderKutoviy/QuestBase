package com.questbase.app.swipeview.swipelib;
...
public class Swipe {
    ...
    private com.questbase.app.swipeview.swipelib.SwipeListener swipeListener;
    private Subscriber<? super com.questbase.app.swipeview.swipelib.SwipeEvent> subscriber;
     ...
     */
    public void addListener(com.questbase.app.swipeview.swipelib.SwipeListener swipeListener) {
     ...
     */
    public Observable<com.questbase.app.swipeview.swipelib.SwipeEvent> observe() {
        this.swipeListener = createReactiveSwipeListener();
        return Observable.create(new Observable.OnSubscribe<com.questbase.app.swipeview.swipelib.SwipeEvent>() {
            @Override
            public void call(final Subscriber<? super com.questbase.app.swipeview.swipelib.SwipeEvent> subscriber) {
    ...
    private com.questbase.app.swipeview.swipelib.SwipeListener createReactiveSwipeListener() {
        return new com.questbase.app.swipeview.swipelib.SwipeListener() {
            @Override
            public void onSwipingLeft(MotionEvent event) {
                onNextSafely(com.questbase.app.swipeview.swipelib.SwipeEvent.SWIPING_LEFT);
            }

            @Override
            public void onSwipedLeft(MotionEvent event) {
                onNextSafely(com.questbase.app.swipeview.swipelib.SwipeEvent.SWIPED_LEFT);
            }

            @Override
            public void onSwipingRight(MotionEvent event) {
                onNextSafely(com.questbase.app.swipeview.swipelib.SwipeEvent.SWIPING_RIGHT);
            }

            @Override
            public void onSwipedRight(MotionEvent event) {
                onNextSafely(com.questbase.app.swipeview.swipelib.SwipeEvent.SWIPED_RIGHT);
            }

            @Override
            public void onSwipingUp(MotionEvent event) {
                onNextSafely(com.questbase.app.swipeview.swipelib.SwipeEvent.SWIPING_UP);
            }

            @Override
            public void onSwipedUp(MotionEvent event) {
                onNextSafely(com.questbase.app.swipeview.swipelib.SwipeEvent.SWIPED_UP);
            }

            @Override
            public void onSwipingDown(MotionEvent event) {
                onNextSafely(com.questbase.app.swipeview.swipelib.SwipeEvent.SWIPING_DOWN);
            }

            @Override
            public void onSwipedDown(MotionEvent event) {
                onNextSafely(com.questbase.app.swipeview.swipelib.SwipeEvent.SWIPED_DOWN);
            }
        };
    }
